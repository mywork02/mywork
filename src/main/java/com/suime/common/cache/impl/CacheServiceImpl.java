package com.suime.common.cache.impl;
...
import com.suime.common.cache.support.StringAsSetCacheHelper;
...
//        } while (!isSuccess && (times < 5));
        ...
        boolean isSuccess = false;
        // 经测试，append不需要cas即可保证原子性，但不能保证并发顺序，在此函数中，我们不需要保证并发的顺序
        memcachedClient.set(key, 0, StringAsSetCacheHelper.serializeToString(element, false)).getStatus().isSuccess();
    }
