...
public class GetSendDocMsgResDto implements Serializable {
	...
	private GetSendDocMsgPageModel result;
	...
	public GetSendDocMsgPageModel getResult() {
		return result;
	}

	public void setResult(GetSendDocMsgPageModel result) {
		this.result = result;
	}
